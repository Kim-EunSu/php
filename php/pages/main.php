...
<section id="blog-type" class="section center type">
            <div class="container">
                <h3 class="section__title">Coffee 블로그</h3>
                <p class="section__desc">커피에 관련된 블로그입니다. 다양한 정보를 확인하세요!</p>
        ...
        if($result){
            ...
            if($count > 0){
                for($i=1; $i<=$count; $i++){
                    ...
                    <a href='../blog/blogView.php?blogID={$blogInfo['blogID']}' style='background-image: url(../assets/img/blog/{$blogInfo['blogImgFile']}'></a></figure>";
...
?>
                    ...
                    <a href="../blog/blogView.php?blogID=37" style="background-image: url(../assets/img/blog/Img_165022195037847.jpeg);"></a></figure>
                    ...
                    <div class="blog__desc">*문화와 종교<br />
...
<br />
출처 : https://ko.wikipedia.org/wiki/%EC%9D%8C%EC%8B%9D</div>
...
?>
                                                        ...
                                                        <!-- <li>
                                    <a href="../board/boardView.php?boardID=310">
                                        test3                                 </a>
                                    <span class="time">
                                        2022-03-24                                    </span>
                                </li>
                                                        <li>
                                    <a href="../board/boardView.php?boardID=309">
                                        test2                                 </a>
                                    <span class="time">
                                        2022-03-24                                    </span>
                                </li>
                                                        <li>
                                    <a href="../board/boardView.php?boardID=308">
                                       test1                                  </a>
                                    <span class="time">
                                        2022-03-24                                    </span>
                                </li>
                                                        <li>
                                    <a href="../board/boardView.php?boardID=307">
                                        김은수                              </a>
                                    <span class="time">
                                        2022-03-24                                    </span>
                                </li> -->
    ...
    if($result){
        ...
        if($count > 0){
            for($i=1; $i<=$count; $i++){
                ...
                echo "<a href='../comment/comment.php?commentID={$commentInfo['commentID']}'>".$commentInfo['youText']."</a></td>";
